package programmers.weeklychallenge.problem83201.choun;
...
public class Solution {
    ...
    public static void main(String[] args) {
        System.out.println(new programmers.math.problem83201.choun.Solution().solution(new int[][]{{100,90,98,88,65},{50,45,99,85,77},{47,88,95,80,67},{61,57,100,80,65},{24,90,94,75,65}}));
    }
}
